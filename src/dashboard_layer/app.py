...
from dashboard_layer.components import render_history_chart, render_kpis, render_result_detail
...
def main() -> None:
    ...
    tabs = st.tabs(["Resumen", "Detalle", "Historico", "Recomendaciones", "Escenarios", "Trazabilidad"])
